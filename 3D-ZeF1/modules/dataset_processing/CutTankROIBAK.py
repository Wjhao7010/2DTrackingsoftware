    ...
    if video_name == 'ch12_20211012020154.mp4':
        if start_time in [
            ...
            time_str = time_str.replace("2021-10-12 8", "2021-10-12 08"). \
                replace("2021-10-12 8", "2021 10 12 08"). \
                replace("2021-10-12 8", "2021 10 12 08"). \
                replace("2021-10-12 8", "2021 10 12 08"). \
                replace("2021-10-12 8", "2021 10 12 08")
        return time_str
...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_floder", default="E:\\data\\3D_pre\\D2_T4", type=str, help="video shear dirpath")
    parser.add_argument("--save_path", default="E:\\data\\3D_pre\\D2_T4\\cut_video", type=str, help="video save path")
    parser.add_argument("--video_name",
                        # default="/home/data/HJZ/zef/0918-0919fish",
                        default="ch12_20211012200000.mp4",
                        type=str, help="video shear dirpath"
                        )
    parser.add_argument("--start_time",
                        # default="/home/data/HJZ/zef/0918-0919fish",
                        default="2021_10_12_21_10_00",
