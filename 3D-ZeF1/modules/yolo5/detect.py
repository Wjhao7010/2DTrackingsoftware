...
from modules.yolo5.utils.general import check_img_size, check_requirements, check_imshow, colorstr, is_ascii, \
    non_max_suppression, \
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='E:\\Project/PyQt5/ZeF/3D-ZeF/best.pt',
                        help='model.pt path(s)'
                        )
    parser.add_argument('--config_path', type=str,
                        # default='/home/data/HJZ/zef/exp_pre/',
                        default='E:\\data\\3D_pre\\D1_T1',
                        help='config path'
                        )
    parser.add_argument('--region_name', type=str, default='2_6PPD1ppm', help='config path')

    parser.add_argument('--source', type=str,
                        default='E:\\data\\3D_pre\\D1_T1\\cut_video/2021_10_11_21_49_59_ch01.avi',
                        help='file/dir/URL/glob, 0 for webcam'
                        )
    parser.add_argument('--project',
                        default='E:\\data\\3D_pre\\processed\\test',
