...
if __name__ == "__main__":
    ...
    ap.add_argument('--config_path', type=str, default='E:\\data\\3D_pre\\D7_T4', help='config path')

    ap.add_argument("-vn", "--VideoName",
                    # default='2021_09_18_19_51_20_D01.avi')
                    default='2021_10_18_05_15_59_ch11.avi')
    ap.add_argument("-o", "--outputPath", default="E:\\data\\3D_pre/D7_T4/processed/")
    ap.add_argument("-r", "--region_name", default="2_6PPDQ500ppb")
    ...
    ap.add_argument("-v", "--show", default=False, action='store_true', help="Show video")
